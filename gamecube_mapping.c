...
struct mapping_controller_unit g_gamecube_status[] = {
	...
	[MAP_GC_AXB_JOY_UP]		= { .type = TYPE_AXIS_TO_BTN, .thres = THRES_25_POS, },
	[MAP_GC_AXB_JOY_DOWN]	= { .type = TYPE_AXIS_TO_BTN, .thres = THRES_25_NEG, },
	[MAP_GC_AXB_JOY_LEFT]	= { .type = TYPE_AXIS_TO_BTN, .thres = THRES_25_POS, },
	[MAP_GC_AXB_JOY_RIGHT]	= { .type = TYPE_AXIS_TO_BTN, .thres = THRES_25_NEG, },
